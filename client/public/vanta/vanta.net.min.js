  ...
  10: function(t, e, i) {
    ...
    class n extends s.b {
      ...
      onInit() {
        ...
        r.addAttribute(
          "position",
          new THREE.BufferAttribute(this.linePositions, 3).setDynamic(!0)
        ),
          r.addAttribute(
            "color",
            new THREE.BufferAttribute(this.lineColors, 3).setDynamic(!0)
          ),
        ...
        const h = new THREE.LineBasicMaterial({
          ...
          blending:
            "additive" === this.blending ? THREE.AdditiveBlending : null,
          transparent: !0
        });
      ...
      onUpdate() {
        ...
        for (let t = 0; t < this.points.length; t++) {
          ...
          const e = this.points[t],
            c = (this.rayCaster
              ? this.rayCaster.ray.distanceToPoint(e.position)
              : 1e3
            ).clamp(5, 15);
          if (
            ((e.scale.x = e.scale.y = e.scale.z = (0.25 * (15 - c)).clamp(
              1,
              100
            )),
            0 !== e.r)
            ...
            (a = Math.sqrt(
              e.position.z * e.position.z + e.position.x * e.position.x
            )),
              (t += 25e-5 * e.r),
          ...
          for (let c = t; c < this.points.length; c++) {
            ...
            if (
              (a = Math.sqrt(u * u + p * p + d * d)) < this.options.maxDistance
            ) {
              var l;
              const c = (2 * (1 - a / this.options.maxDistance)).clamp(0, 1);
              (l =
                "additive" === this.blending
                  ? new THREE.Color(0).lerp(h, c)
                  : n.clone().lerp(r, c)),
      ...
      onMouseMove(t, e) {
        ...
        return (
          (i.tz = o * Math.sin(n)),
          (i.tx = o * Math.cos(n)),
          (i.ty = i.oy + 10 * (e - 0.5) * (this.options.mouseCoeffY || 1)),
          this.rayCaster,
          (this.rcMouseX = 2 * t - 1),
          (this.rcMouseY = 2 * -t + 1)
        );
