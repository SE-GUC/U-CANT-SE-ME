...
export default class AwaitingPayment extends Component {
    state ={
        cases :[],
        caseid:"",
        investorID:"",
    ...
    async componentDidMount(){
        ...
        const getCases = await axios.get(`api/investors/getMyAccCases/${id}`);
    ...
    render() {
        ...
        return (
            this.state.cases.length===0?<h1> There are no cases awaiting payment</h1>:
