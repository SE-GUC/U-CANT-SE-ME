...
export default class NavBarDashboard extends Component {
    ...
    render() { 
        ...
        const styles = {
            ...
            if(this.state.electronicJournals){ //electronicJournals
                this.setState({dashboard: false})
                this.setState({homepage: false})
                this.setState({profile: false})
                this.setState({electronicJournals: false})
        ...
        return (
            ...
            <div className="Header" id="Header" style={styles.Header} ref="Header">
              ...
              {this.props.LeftButton? <button><i class="left"></i></button>:<label/>} 
              {/* on click handle whatever you want with the back button */} 
                <label style={styles.SumergiteLabel}>
                    Sumergite
                </label>
                  ...
                  <ul className="navbar-nav ml-auto">
                    ...
                    <li className="nav-item mr-auto">
                      <button
                        ...
                        onClick={() => {this.setState({dashboard: true})}}
                        // disableRipple = {true}
                        >
                      <span id="buttonHome" style={styles.Dashboard}>Dashboard</span> 
                      </button>
                    </li>: 
                    <li className="nav-item mr-auto">
                        <button
                        ...
                        data-toggle="collapse"
                        data-target=".navbar-collapse.show"
                          onClick={() => {this.setState({electronicJournals: true})}}
                          // disableRipple = {true}
                          >
                        <span id="buttonHome" style={styles.ElectronicJournals}>Electronic Journals</span> 
                        </button>
                    </li>
                    }
                    <li className="nav-item mr-auto">
                      <button
                        ...
                        // disableRipple = {true}
                        >
                      <span id="buttonHome" style={styles.HomePage}>Homepage</span> 
                      </button>
                    </li>
                    {this.props.PROFILE?
                    <li className="nav-item mr-auto">
                      <button
                        ...
                        // disableRipple = {true}
                        >
                      <span id="buttonHome" style={styles.Profile}>Profile</span>
                      </button>
                    </li> : <label/>
                    }
                  </ul>
