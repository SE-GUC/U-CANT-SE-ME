...
makingHtmlForSSC = async function(caseId) {
  ...
  if (form.form.regulatedLaw === "159") {
    band0 ='<h1>تمھید</h1>'
    band0+=  "<p>" 
    band0+= "في إطار أحكام القانون المصري وافق الموقع على هذا النظام الأساسي على تأسيس شركة شخص واحد تحت اس";
    band0 += companyName;
    band0 += " وتأسيساً على ذلك تقدم بهذا النظام الأساسي إلى الهيئة العامة للاستثمار والمناطق الحرة ، حيث قامت بإجراء المراجعة اللازمة له ."+'<br>';
    ...
    band0 += "  وقد أقر المؤسس بالالتزام بأحكام هذا النظام الأساسي وأحكام القانون المصري، وبصفة خاصة قانون الشركات المشار إليه ولائحته التنفيذية ." ;
    band0 +=  "</p>";
  ...
  if (form.form.regulatedLaw === "72") {
    band0 ='<h1>تمھید</h1>'
    band0+=  "<p>" 
    band0+=  "في إطار أحكام القانون المصري وافق الموقع على هذا النظام الأساسي على تأسيس شركة شخص واحد تحت اسم ";
    band0 += companyName;
    ...
    band0 +=" وقد وافق على تأسيس شركة شخص واحد مصرية الجنسية وفقاً لأحكام القوانين النافذة وعلى وجه الخصوص قانون الشركات ولائحته التنفيذية وقانون الاستثمار الصادر بالقانون رقم 72 لسنة 2017 ، ويشار إليه فيما بعد باسم قانون الاستثمار ولائحته التنفيذية وأحكام هذا النظام الأساسي." ;
     band0+= "</p>";
    band8 =
      "<p>" +
  ...
  var band1 ='<h1>الماده١</h1>'+
    ...
    "اسم الشركة" +
    "</p>";
  var band2 = '<h1>الماده ٢</h1>' +"<p>" + "بيانات مؤسس الشركة:";
  ...
  var band9 ='<h1>الماده ٩</h1>' +"<p>" + "ينشر هذا النظام طبقا لأحكام القانون ." + "</p>";
  var band6 = '<h1>الماده ٦</h1>';
  ...
  var band5 ='<h1>الماده ٥</h1>'+
    ...
    "</p>";
  var band4 = '<h1>الماده ٤</h1>'+"<p>" + "حدد رأسمال الشركة بمبلغ";
  band4 +=
    capital +
    "(" +
  ...
  var all =
  `<!doctype html><html><head><style> table, td, th {border: 1px solid black;}table {border-collapse: collapse;width: 100%;}th {text-align: right;}td{ text-align: right;} h1{text-align:center;font-weight: bold;font-size: 18px;}p{text-align:right;font-weight: normal;font-size: 12px;} </style></head><body>`+
    band0 +
    band1 +
    band2 +
    band3 +
